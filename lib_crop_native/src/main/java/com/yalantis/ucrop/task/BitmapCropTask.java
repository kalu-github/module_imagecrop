...
public class BitmapCropTask extends AsyncTask<Void, Void, Throwable> {
    ...
    private boolean crop(float resizeScale) throws IOException {
        ...
        if (shouldCrop) {
            Log.e("BitmapCropTask", "cropCImg => mImageInputPath = " + mImageInputPath + ", mImageOutputPath = " + mImageOutputPath);
     ...
     * @param angle
     * @param resizeScale
     * @param format          JPEG:0, PNG:1
     * @param quality         压缩质量 0-100
     * @param exifDegrees     旋转角度
     * @param exifTranslation
     * @return
     * @throws IOException
     * @throws OutOfMemoryError
     */
    @SuppressWarnings("JniMissingFunction")
    native public static boolean cropCImg(String inputPath,
                                          String outputPath,
                                          int left,
                                          int top,
                                          int width,
                                          ...
                                          float angle,
                                          float resizeScale,
                                          @IntRange(from = 0, to = 1) int format,
