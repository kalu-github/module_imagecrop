...
METHODDEF(void) my_error_exit(j_common_ptr cinfo) {
    ...
    jclass nativeCallBackClass = menv->FindClass("lib/kalu/image/OnCompressChangeListener");
...
int generate(BYTE *data, int w, int h, int quality,
    ...
    jclass nativeCallBackClass = menv->FindClass(
            "lib/kalu/image/OnCompressChangeListener");
...
Java_lib_kalu_image_CompressNative_nativeJpeg(JNIEnv *env,
                                                             jclass type,
                                                             jstring outpath_,
                                                             jobject bitmap,
    ...
    jclass nativeCallBackClass = env->FindClass("lib/kalu/image/OnCompressChangeListener");
